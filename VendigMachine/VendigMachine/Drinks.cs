...
{
    public class Drinks : VendingMachine, IProduct
    {
        public string name;
        public int size;
        ...
        public Drinks(string name, int size, string description, string tag, int price)
        {
            this.name = name;
            this.size = size;
        ...
        {
            Console.WriteLine("You just drank " + name);
        }
    }
}
